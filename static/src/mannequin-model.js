...
export const BONE_CHILDREN = {
    ...
    forearm_L:   ['hand_L'],
    hand_L:      ['index_L_1', 'middle_L_1', 'ring_L_1', 'pinky_L_1', 'thumb_L_1'],
    index_L_1:   ['index_L_2'],
    index_L_2:   ['index_L_3'],
    index_L_3:   [],
    middle_L_1:  ['middle_L_2'],
    middle_L_2:  ['middle_L_3'],
    middle_L_3:  [],
    ring_L_1:    ['ring_L_2'],
    ring_L_2:    ['ring_L_3'],
    ring_L_3:    [],
    ...
    forearm_R:   ['hand_R'],
    hand_R:      ['index_R_1', 'middle_R_1', 'ring_R_1', 'pinky_R_1', 'thumb_R_1'],
    index_R_1:   ['index_R_2'],
    index_R_2:   ['index_R_3'],
    index_R_3:   [],
    middle_R_1:  ['middle_R_2'],
    middle_R_2:  ['middle_R_3'],
    middle_R_3:  [],
    ring_R_1:    ['ring_R_2'],
    ring_R_2:    ['ring_R_3'],
    ring_R_3:    [],
...
export const PROPORTIONS = {
    F: {
        ...
        // left hand phalanges — radii taper distally
        index_L_1:   { radius: 0.012 },
        index_L_2:   { radius: 0.010 },
        index_L_3:   { radius: 0.009 },
        middle_L_1:  { radius: 0.012 },
        middle_L_2:  { radius: 0.010 },
        middle_L_3:  { radius: 0.009 },
        ring_L_1:    { radius: 0.012 },
        ring_L_2:    { radius: 0.010 },
        ring_L_3:    { radius: 0.009 },
        pinky_L_1:   { radius: 0.012 },
        pinky_L_2:   { radius: 0.010 },
        pinky_L_3:   { radius: 0.009 },
        thumb_L_1:   { radius: 0.014 },
        thumb_L_2:   { radius: 0.012 },
        // right hand phalanges — radii taper distally
        index_R_1:   { radius: 0.012 },
        index_R_2:   { radius: 0.010 },
        index_R_3:   { radius: 0.009 },
        middle_R_1:  { radius: 0.012 },
        middle_R_2:  { radius: 0.010 },
        middle_R_3:  { radius: 0.009 },
        ring_R_1:    { radius: 0.012 },
        ring_R_2:    { radius: 0.010 },
        ring_R_3:    { radius: 0.009 },
        pinky_R_1:   { radius: 0.012 },
        pinky_R_2:   { radius: 0.010 },
        pinky_R_3:   { radius: 0.009 },
        thumb_R_1:   { radius: 0.014 },
        thumb_R_2:   { radius: 0.012 },
        shoulderSpan: 0.270,
    },
    M: {
        torso:       { length: 0 }, // virtual root, no geometry — transform origin only
