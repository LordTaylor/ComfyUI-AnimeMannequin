...
export const PROPORTIONS = {
    F: {
        ...
        thumb_L:     { radius: 0.012 },
        index_L:     { radius: 0.011 },
        middle_L:    { radius: 0.011 },
        ring_L:      { radius: 0.010 },
        pinky_L:     { radius: 0.009 },
        thumb_R:     { radius: 0.012 },
        index_R:     { radius: 0.011 },
        middle_R:    { radius: 0.011 },
        ring_R:      { radius: 0.010 },
        pinky_R:     { radius: 0.009 },
        shoulderSpan: 0.270,
    },
    M: {
        torso:       { length: 0 }, // virtual root, no geometry — transform origin only
